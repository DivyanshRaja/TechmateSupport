...
public class DeviceRepository {
    ...
    public void getDeviceList(HashMap<String, Object> hashmap, ApiStatusListener apiStatusListener) {
        apiStatusListener.onRequestStart();
        apiInterface.getDeviceList(hashmap).enqueue(new Callback<ResponseHandlerModel>() {
            @Override
            public void onResponse(@Nullable Call<ResponseHandlerModel> call, @Nullable Response<ResponseHandlerModel> response) {
                ...
                if (response.body() != null) {
                    ...
                    if (!responseString.equals("")) {
                        ...
                        Type type = new TypeToken<ArrayList<DeviceModel>>() {
                        }.getType();
                        ArrayList<DeviceModel> list = converter.fromJson(String.valueOf(jsonArray), type);
                        if (list == null) {
